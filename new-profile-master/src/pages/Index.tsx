...
import { Github, Mail, ExternalLink, Code, Database, Laptop, Users, Target, MessageCircle, Linkedin } from 'lucide-react';
...
const Index = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Scalable e-commerce platform built with microservices architecture. Features include inventory management, payment processing, order tracking, and customer analytics dashboard.',
      tech: ['React', 'Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'Kubernetes'],
      github: 'https://github.com/ragner01',
      demo: '#',
      category: 'Microservices',
      highlights: ['99.9% uptime', 'Handles 10k+ concurrent users', 'Auto-scaling']
    },
    {
      title: 'Real-Time Analytics Dashboard',
      description: 'Interactive business intelligence dashboard with live data visualization, custom report generation, and predictive analytics. Integrates with multiple data sources and APIs.',
      tech: ['React', 'TypeScript', 'ASP.NET Core', 'MongoDB', 'Chart.js', 'WebSocket'],
      github: 'https://github.com/ragner01',
      demo: '#',
      category: 'Data Visualization',
      highlights: ['Real-time updates', 'Custom charts', 'Export capabilities']
    }
  ];

  const SkillBar = ({ skill, index }: { skill: typeof skills[0], index: number }) => (
    <div className={`animate-fade-in-left transition-all duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`} 
